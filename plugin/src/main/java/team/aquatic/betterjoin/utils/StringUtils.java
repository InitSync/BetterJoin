...
public class StringUtils {
	private final static int CENTER_MOTD_PX = 127;
  ...
  private final static StringBuilder STRING_BUILDER = new StringBuilder();
    ...
    public int getLength() {
      return this.length;
		...
		public static DefaultFontInfo getDefaultFontInfo(char c) { return CHAR_MAP.getOrDefault(c, DEFAULT); }
	}
}
